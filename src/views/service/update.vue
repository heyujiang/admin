        ...
        <el-tabs v-model="activeName">
          <el-tab-pane style="padding-top:10px" label="基本信息" name="基本信息">
            ...
            <div v-if="form.is_points_goods!=1">
              ...
              <el-row>
                <el-col :span="24">
                  <el-form-item label="是否存在特殊时间阶段">
                    <el-switch v-model="form.is_special_time_period" :active-value="1" :inactive-value="0" />
                  </el-form-item>
                </el-col>
              </el-row>
              <div v-if="form.is_special_time_period==1">
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="特殊时间段">
                      <el-time-picker v-model="form.special_time_start" style="width:180px;" value-format="HH:mm" format="HH:mm" clearable placeholder="请输入开始时间"/>
                      <el-time-picker v-model="form.special_time_end" style="width:180px;" value-format="HH:mm" format="HH:mm" clearable placeholder="请输入结束时间" />
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :span="24">
                    <el-form-item label="特殊时段价格规则">
                      <el-input v-model="form.special_time_price_num" style="width:500px;" auto-complete="off" clearable placeholder="请输入">
                        <template slot="append"><span v-if="form.special_time_price_type">元</span><span v-else>倍</span>
                          <el-radio-group v-model="form.special_time_price_type" style="padding-left: 10px;">
                            <el-radio :label="0">原有价格翻倍</el-radio>
                            <el-radio :label="1">原有价格增加</el-radio>
            ...
            <el-row>
              <el-col :span="24">
                <el-form-item label="支持尾款" prop="is_additional">
                  <el-switch v-model="form.is_additional" :active-value="1" :inactive-value="0" />
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
          ...
          <el-tab-pane style="padding-top:10px" label="次卡设置" name="次卡设置">
            <el-row>
              <el-col :span="24">
                <el-form-item label="支持次卡" prop="is_bout_card">
                  <el-switch v-model="form.is_bout_card" :active-value="1" :inactive-value="0" />
                </el-form-item>
              </el-col>
            </el-row>
            <div v-if="form.is_bout_card==1">
              <el-row>
                <el-col :span="24">
                  <el-form-item label="次卡价格" prop="bout_card_price">
                    <el-input v-model="form.bout_card_price" auto-complete="off" clearable placeholder="请输入次卡价格" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="24">
                  <el-form-item label="支持次数" prop="bout_card_bout">
                    <el-input v-model="form.bout_card_bout" auto-complete="off" clearable placeholder="请输入次数" />
                  </el-form-item>
                </el-col>
              </el-row>
              <el-row>
                <el-col :span="24">
                  <el-form-item label="有效期" prop="bout_card_date">
                    <el-date-picker v-model="form.bout_card_date" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择有效期"></el-date-picker>
                  </el-form-item>
                </el-col>
              </el-row>
            </div>
...
export default {
  ...
  watch: {
    show(val) {
      if (val) {
        this.$api.post('/goods/getField', { ptype: 2 }).then(res => {
