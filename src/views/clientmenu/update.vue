  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="未登录名称">
              <el-input v-model="form.title1" auto-complete="off" clearable placeholder="请输入未登录名称" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="条件">
              <el-input v-model="form.tiaojian" auto-complete="off" clearable placeholder="请输入条件" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row v-if="form.url=='customurl'">
          <el-col :span="24">
            <el-form-item label="自定义页面">
              <el-input v-model="form.customurl" auto-complete="off" clearable placeholder="请输入参数" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
