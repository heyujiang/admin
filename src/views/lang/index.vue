      ...
      >
        <template slot-scope="scope">
          <div v-if="scope.row.id">
            <el-button
              v-if="checkPermission('/lang/update')"
              size="mini"
              type="primary"
            ...
            />修改</el-button>
            <el-button
              v-if="checkPermission('/lang/delete')"
              size="mini"
              type="danger"
              @click="del(scope.row)"
            ><i
...
import Update from '@/views/lang/update.vue'
...
export default {
  ...
  methods: {
    getList() {
      ...
      this.loading = true
      this.$api.post('/lang/index', param).then(res => {
        this.list = res.data
        this.loading = false
