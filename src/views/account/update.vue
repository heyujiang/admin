  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="后台登录背景图">
              <ImagesUpload size="small" file-type="image" :image.sync="form.loginbgimg" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="到期日期">
              <el-date-picker v-model="form.endtime" type="date" placeholder="选择时间" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
  ...
  methods: {
    ...
    submit() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          this.loading = true
          this.$api.post('/account/update', this.form).then(res => {
            this.$message({
              message: res.msg,
              type: 'success'
            })
