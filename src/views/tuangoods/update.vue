  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="拼团价格" prop="tuan_price">
              <el-input v-model="form.tuan_price" style="width:300px;" auto-complete="off" clearable placeholder="请输入价格">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="成团人数" prop="people_num">
              <el-input-number
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="拼团时效" prop="time_limit">
              <el-input
  ...
  methods: {
    ...
    submit() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          this.loading = true
          this.$api.post('/tuangoods/update', this.form).then(res => {
            this.$message({
              message: res.msg,
              type: 'success'
            })
