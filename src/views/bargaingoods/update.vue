  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="活动底价" prop="bargain_price">
              <el-input v-model="form.bargain_price" style="width:300px;" auto-complete="off" clearable placeholder="请输入价格">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="砍价有效时长" prop="time_limit">
              <el-input
...
<script>
import SelectGoods from '@/views/bargaingoods/selectGoods.vue'
export default {
  name: 'Bargaingoodsupdate',
  ...
  methods: {
    ...
    submit() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          this.loading = true
          this.$api.post('/bargaingoods/update', this.form).then(res => {
            this.$message({
              message: res.msg,
              type: 'success'
            })
