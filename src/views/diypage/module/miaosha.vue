<template>
  <div class="module-item-miaosha" style="margin-top:0">
    <div :style="'padding:' + module.base.paddingTop + 'px 0;'">
      <div class="item-miaosha-con" :style="style">
        <moduleBg :base="module.base" />
        <moduleTitle v-if="module.title.title.show" :title="module.title" />
        <div class="item-miaosha" :class="'style'+module.base.column">
            ...
            <div class="item">
              ...
              <div class="c">
                <div v-if="module.base.text.show" class="tit">
                  <moduleText :text="module.base.text" name="此处显示名称" />
                </div>
          ...
          <template v-if="module.base.source=='choice'">
            ...
            <div v-if="module.list.length == 0" class="noadd">
              <el-button type="primary" size="mini" icon="el-icon-plus" @click="addMiaosha">添加秒杀</el-button>
            </div>
          </template>
        </div>
      </div>
    ...
    <!--添加商品弹窗-->
    <SelectMiaosha :show.sync="showSelectMiaosha" size="small" />
  </div>
</template>
...
import SelectMiaosha from '@/views/diypage/attr/selectMiaosha.vue'
export default {
  components: {
    moduleBg,
    moduleText,
