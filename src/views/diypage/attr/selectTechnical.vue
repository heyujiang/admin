    ...
    >
      <div>
        ...
        >
          ...
          <el-table-column align="center" property="touxiang" label="图片" show-overflow-tooltip width="90">
          ...
          <el-table-column align="left" property="dizhi" label="地址" show-overflow-tooltip width="" />
          <el-table-column
          ...
          >
            <template slot-scope="scope">
              <div v-if="scope.row.id">
                <el-button size="mini" type="primary" @click="selectTechnical(scope.row)"><i
                  class="el-icon-edit"
                />选择</el-button>
              </div>
            </template>
...
export default {
  ...
  methods: {
    ...
    index() {
      ...
      this.$api.post('/technical/index', param).then(res => {
    ...
    selectTechnical(item) {
      ...
      const technical = JSON.parse(arr)
      technical.cm = item
      let flag = true
    ...
    closeSelect() {
      this.$parent.showSelectTechnical = false
    }
  }
}
</script>
