        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="链接">
              <el-input v-model="form.url" auto-complete="off" clearable placeholder="请输入标题" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="24">
            <el-form-item label="图片">
              <ImagesUpload size="small" file-type="image" :image.sync="form.pic" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  methods: {
    ...
    submit() {
      this.$refs['form'].validate(valid => {
        if (valid) {
          this.loading = true
          this.$api.post('/ad/update', this.form).then(res => {
            this.$message({
              message: res.msg,
              type: 'success'
            })
