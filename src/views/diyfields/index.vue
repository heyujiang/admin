    ...
    <el-row class="app-toptool" type="flex">
      ...
      <el-col :span="8">
        <div class="btn-group" style="margin-bottom:11px;float: right;">
          <div>
            <el-button
              v-if='"store" != controller && "technical" != controller || checkPermission(`/${controller}/add`)'
              type="primary"
              size="small"
              icon="el-icon-plus"
              @click="add()"
            ...
            <el-button
              v-if="checkPermission('/diyfields/delete')"
              type="primary"
              :disabled="multiple"
              size="small"
              icon="el-icon-delete"
            ...
            <el-button
              v-if="checkPermission('/diyfields/importData')"
              type="primary"
              size="small"
              icon="el-icon-upload"
            ...
            <el-button
              v-if="checkPermission('/diyfields/dumpdata')"
              type="primary"
              size="small"
          ...
          <template slot-scope="scope">
            <div v-if="scope.row.id">
              <el-button size="mini" type="primary"
                         v-if="checkPermission('/'+controller+'/login') && 'index' == action && 'store' == controller"
                         @click="login(scope.row)"
              >
                登录后台
              </el-button>
              <el-button size="mini" type="primary"
                         v-if="checkPermission('/'+controller+'/auditdetail') &&  'audit' == action"
