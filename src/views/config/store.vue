  ...
  <div class="app-container ">
    <el-form ref="form" size="small" :model="form" :rules="rules" label-width="180px">
      <el-tabs v-model="activeName">
        <el-tab-pane style="padding-top:10px" label="商家设置" name="商家设置">
          <el-row>
            <el-col :span="24">
              <el-form-item label="商家抢单">
                <el-radio-group v-model="form.is_pickuporder">
                  <el-radio label="0">关闭</el-radio>
                  <el-radio label="1">开启</el-radio>
                </el-radio-group>
                <div class="help-block">开启后，商家可以手机端抢单</div>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item label="商家主页推荐平台商品">
                <el-radio-group v-model="form.is_recommendgoods">
                  <el-radio label="0">关闭</el-radio>
                  <el-radio label="1">开启</el-radio>
                </el-radio-group>
                <div class="help-block">开启后，商家主页推存平台商品</div>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item label="默认返佣比例">
                ...
                <div class="help-block">商家默认返佣比例</div>
              </el-form-item>
            </el-col>
          </el-row>
