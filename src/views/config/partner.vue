  ...
  <div class="app-container ">
    <el-form ref="form" size="small" :model="form" :rules="rules" label-width="180px">
      <el-tabs v-model="activeName">
        <el-tab-pane style="padding-top:10px" label="合伙人设置" name="合伙人设置">

          <el-row>
            <el-col :span="24">
              <el-form-item label="成为合伙人条件">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="消费自动成为合伙人">
                <el-input
                  v-model="form.auto_share_val"
                  style="width:500px;"
                  auto-complete="off"
                  clearable
                  placeholder="请输入消费自动成为合伙人"
                >
                  <template slot="append">元</template>
                </el-input>
                <div class="help-block">消费满指定金额(付款即生效,无需过售后)自动成为合伙人，0元表示不自动</div>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item label="购买商品自动成为合伙人">
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="用户须知">
                <el-input v-model="form.content" type="textarea" auto-complete="off" :autosize="{ minRows: 2, maxRows: 4}" clearable placeholder="请输入用户须知" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item label="申请协议">
                <el-input v-model="form.agree" type="textarea" auto-complete="off" :autosize="{ minRows: 2, maxRows: 4}" clearable placeholder="请输入申请协议" />
              </el-form-item>
            </el-col>
          </el-row>
        </el-tab-pane>
